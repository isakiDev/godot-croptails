...
# equivalent to the duration in minutes (its better to use a float number because its more precise) 
...
var time: float = 0.0
# flag used only to check if the minute has been calculated
